...
- 三平台安装载荷继续执行下述 v0.2.2 的完整门禁；实际结果以 [v0.2.3 Release](https://github.com/lixia3987-netizen/cc-desk/releases/tag/v0.2.3) 关联的 Actions 记录为准，发布必须等待门禁全部成功。CI 附件同时保存五套主题截图。
