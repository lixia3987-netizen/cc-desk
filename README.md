...
已发布版本的改动、下载与使用边界见 [v0.5.0 版本说明](docs/releases/v0.5.0.md)。引擎边界、v3 数据、按引擎维护及竖向工具窗口属于后续源码改动，尚未包含在该版本安装包中。阶段二代码候选为 `a4e34ce736dd59a6c29ca3a5878a64d0a10b2711`，验收状态：**已完成，三平台验收通过**；证据和平台验证范围见 [阶段二验收记录](docs/ENGINE-BOUNDARIES-PHASE-2-VALIDATION.md)。本阶段仅集成到 `dev/native-agent`，不合入 main、不发布 Release。
