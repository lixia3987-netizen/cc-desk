...
- **阅读顺手**：聊天与菜单独立设置字体和字号，使用系统字体或导入本机字体；五套主题、Markdown、代码高亮及 Mermaid 源码 / 预览切换。
...
- 默认使用**系统字体**，支持导入 **TTF、OTF、WOFF、WOFF2**，单个最多 20 MiB、最多 24 个；保存应用内副本，原文件移动后仍可使用。
...
| 字体与分类设置（主分支新增） | 聊天 / 菜单字体和字号独立配置、系统字体、本机导入与移除；左侧五类菜单，右侧配置即时预览 |
